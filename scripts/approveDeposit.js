...
async function main() {
  ...
  const NFT = await ethers.getContractFactory("DogePound");
  const nft = await NFT.attach('0xb9E164CD30B2Ce37B6ac6eD1a9000FBfDdaa019d');
  ...
  console.log("DogePoundNFT balance of", wallet.address, "is: ", balance.toString());
}
